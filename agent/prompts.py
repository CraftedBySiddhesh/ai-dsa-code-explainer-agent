...
PLAN_USER = "Return JSON with keys: strategy_name, key_observation, pitfalls\nPROBLEM_JSON:\n{problem_json}"
...
REPAIR_SYSTEM = "You fix notebook markdown to satisfy issues. Use ONLY PROBLEM_JSON. Output corrected markdown only."
REPAIR_USER = "PROBLEM_JSON:\n{problem_json}\n\nISSUES:\n{issues}\n\nCURRENT_MARKDOWN:\n{md}"
